          ...
          <div className="flex flex-col items-center justify-center pt-10 md:pt-16 xl:pt-24 2xl:pt-36 3xl:pt-[165px] gap-y-20 w-full">
            <div className="flex flex-col items-center gap-10 2xl:gap-y-[60px] z-10">
              <div className="flex flex-col items-center gap-y-3">
                {/* Title */}
                <Heading
                  className="text-2xl md:text-4xl lg:text-5xl xl:text-[65px] 2xl:text-7xl 3xl:text-[80px] not-italic font-semibold xl:font-bold leading-[150%] md:leading-[132%] tracking-[-0.8px] text-center !text-white max-w-[942px]"
                  Txt={data?.title}
                />
